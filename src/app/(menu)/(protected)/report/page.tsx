...
const BackIcon = () => (
  ...
  >
    <path
      d="M27 7.78788L24.4216 6L10 16L24.4216 26L27 24.2121L15.1568 16L27 7.78788Z"
      fill="#24507F"
    />
  </svg>
);
...
const BugIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_bug)">
      <path
        d="M12 22.5C16.5765 22.5 19.8815 19.4615 19.98 14.8865C19.9933 14.3032 20 13.6743 20 13C20 11.9885 19.993 11.697 19.98 11.1135C19.882 6.5385 16.577 3.5 12 3.5C7.424 3.5 4.1185 6.5385 4.02 11.1135C4.00656 11.7422 3.99989 12.3711 4 13C4 13.6747 4.00667 14.3035 4.02 14.8865C4.118 19.4615 7.4235 22.5 12 22.5Z"
        fill="#8FBFFA"
      />
      <path
        d="M12 22.5C16.5765 22.5 19.8815 19.4615 19.98 14.8865C19.9933 14.3032 20 13.6743 20 13C20 11.9885 19.993 11.697 19.98 11.1135C19.882 6.5385 16.577 3.5 12 3.5C7.424 3.5 4.1185 6.5385 4.02 11.1135C4.00656 11.7422 3.99989 12.3711 4 13C4 13.6747 4.00667 14.3035 4.02 14.8865C4.118 19.4615 7.4235 22.5 12 22.5Z"
      ...
      />
      <path
        d="M8 1.5L9 3.5M16 1.5L15 3.5M12 10.5V22.5"
        stroke="#2859C5"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M19.7475 9C17.5505 9.808 14.9175 10.25 12 10.25C9.08245 10.25 6.44895 9.808 4.25195 9"
        stroke="#2859C5"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <path
        d="M20 10.5L22.5 9.5M20 16.5L22.5 17.5M20 13.5H22.75M4 10.5L1.5 9.5M4 16.5L1.5 17.5M4 13.5H1.25"
        stroke="#2859C5"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_1086_1093"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_1086_1093"
          result="shape"
        />
      </filter>
  ...
  >
    <g clipPath="url(#clip0_safety)">
      ...
      <g mask="url(#mask0_safety)">
        <path
          d="M9.73789 0.25C12.7999 0.25 16.4884 0.979 17.3199 1.655C17.6534 1.94891 17.9415 2.29062 18.1749 2.669C19.2554 4.4825 19.2749 8.9225 19.2749 10.579C19.2749 16.897 10.9349 19.706 10.1769 19.706C9.64139 19.706 5.32289 18.3045 2.83289 15.2545C1.56789 13.9015 0.639893 12.1845 0.639893 10.077C0.639893 8.2255 0.664393 2.923 2.15639 1.6545C2.98739 0.979 6.67639 0.25 9.73789 0.25Z"
          fill="#00034A"
          stroke="#00034A"
          strokeWidth="0.5"
          strokeMiterlimit="10"
        />
        <path
          d="M17.3199 1.655C16.4884 0.9785 12.7999 0.25 9.73789 0.25C6.67589 0.25 2.98739 0.979 2.15639 1.655C0.664393 2.9225 0.639893 8.225 0.639893 10.0765C0.639893 16.3945 8.97989 19.204 9.73789 19.204C10.4959 19.204 18.8359 16.3945 18.8359 10.0765C18.8359 8.2295 18.8119 2.9225 17.3199 1.654V1.655Z"
          fill="#8FBFFA"
          stroke="#00034A"
          strokeWidth="0.5"
          strokeMiterlimit="10"
        />
        <path
          d="M14.112 6.4755C13.441 6.33562 12.7562 6.27371 12.071 6.291C12.0905 5.60722 12.0284 4.92356 11.886 4.2545C11.7015 3.443 10.467 3.341 9.74798 3.341C9.02848 3.341 7.80398 3.443 7.60448 4.2545C7.46478 4.92397 7.4027 5.60731 7.41948 6.291C6.73596 6.27426 6.05279 6.33633 5.38348 6.476C4.57198 6.6605 4.46948 7.9 4.46948 8.619C4.46948 9.3385 4.57198 10.563 5.38348 10.7575C6.05248 10.8995 6.73598 10.9615 7.41998 10.9425C7.40248 11.6275 7.46498 12.3125 7.60448 12.9835C7.78948 13.795 9.02848 13.897 9.74798 13.897C10.467 13.897 11.692 13.795 11.886 12.9835C12.0285 12.313 12.091 11.6275 12.071 10.942C12.756 10.962 13.441 10.9 14.112 10.7575C14.9235 10.5725 15.026 9.3385 15.026 8.619C15.026 7.9 14.943 6.6605 14.112 6.4755Z"
          fill="white"
          stroke="#00034A"
          strokeWidth="0.5"
          strokeMiterlimit="10"
...
const UploadIcon = () => (
  ...
  >
    <g clipPath="url(#clip0_upload)">
      <path
        d="M10.7501 11.1667V6.75207L9.23341 8.16041L8.41675 7.37499L11.3334 4.66666L14.2501 7.37499L13.4334 8.16041L11.9167 6.75207V11.1667H10.7501ZM7.83341 13.3333C7.51258 13.3333 7.23803 13.2273 7.00975 13.0154C6.78147 12.8034 6.66714 12.5483 6.66675 12.25V10.625H7.83341V12.25H14.8334V10.625H16.0001V12.25C16.0001 12.5479 15.8859 12.803 15.6577 13.0154C15.4294 13.2277 15.1546 13.3337 14.8334 13.3333H7.83341Z"
        fill="#2859C5"
      />
    </g>
    <defs>
...
export default function ReportProblemPage() {
  ...
  return (
    <div className=" bg-gray-100 flex items-center justify-center">
      ...
      <div className="w-full h-full bg-white py-10 relative overflow-hidden shadow-2xl flex flex-col">
        {/* Header */}
        <div className="flex  items-center px-5 mb-[50px]">
          <BackButton />
          <div className="text-cyan-800 text-base font-semibold font-['Poppins']  mx-auto text-center ">
            Report a Problem
          </div>
        </div>
        ...
        <div className="px-[21px] flex flex-col gap-4">
          ...
          <div className="w-80 h-60 bg-slate-200 rounded-[30px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] relative mx-auto shrink-0">
            ...
            <div className="absolute top-[45px] w-full px-[10px] grid grid-cols-2 gap-x-[15px] gap-y-[11px]">
              ...
              >
                ...
                <div className="text-black text-xs font-semibold font-['Inter'] leading-5">
                  Bug Report
                </div>
              </button>
              ...
              >
                ...
                <div className="text-black text-base font-semibold font-['Inter'] leading-5 text-[14px]">
                  Feature Request
                </div>
              </button>
          ...
          <div className="w-80 h-20 bg-slate-200 rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] relative mx-auto shrink-0 p-4">
            <div className="text-cyan-800 text-xs font-normal font-['Poppins'] leading-5 mb-1 ml-1">
              Subject
            </div>
            <input
              type="text"
          ...
          <div className="w-80 h-24 bg-slate-200 rounded-[20px] relative mx-auto shrink-0 p-4">
            <div className="text-cyan-800 text-xs font-normal font-['Poppins'] leading-5 mb-1 ml-2">
              Attachments
            </div>
            <div className="w-full h-9 bg-white rounded-[5px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border-[0.50px] border-neutral-500 flex items-center justify-center gap-2 cursor-pointer hover:bg-gray-50">
              <UploadIcon />
              <span className="text-neutral-500 text-2xs font-normal font-['Poppins'] leading-5">
          ...
          <button className="w-64 p-2.5 bg-blue-200 rounded-sm shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] flex justify-center items-center gap-2.5 mx-auto mt-4 hover:bg-blue-300 transition-colors">
            <div className="text-center justify-start text-neutral-600 text-xs font-bold font-['Inter'] leading-5">
              Submit Report
            </div>
          </button>
        </div>
