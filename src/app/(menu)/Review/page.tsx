...
const REVIEWS = [
  {
    ...
    comment: "Sophia was amazing to work with! She explained everything clearly and made learning so enjoyable. In return, she gave me great design advice that improved my portfolio. Highly recommend trading skills with her!",
    avatar: ""
  },
  {
    id: 2,
    ...
    rating: 5,
    skill: "Art",
    comment: "One of the best partners I’ve met on the platform! She’s enthusiastic, creative, and communicates perfectly. The exchange felt balanced, and I learned a lot from her artistic perspective.",
    avatar: ""
  },
  {
    id: 3,
    ...
    comment: "Working with Sophia was a great experience! She helped me redesign my project’s user interface, making it more intuitive and visually consistent.",
    avatar: ""
  }
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <header className="flex items-center px-4 py-6">
        <Button variant="ghost" size="icon" className="text-secondary hover:bg-muted">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="px-6 py-4">
          <div className="flex gap-8 items-center border border-muted p-5 rounded-[15px]">
            <div className="flex flex-col items-center">
              <span className="text-[36px] font-black text-[#121417] leading-none">4.5</span>
              <div className="flex gap-0.5 mt-2">
                {[1, 2, 3, 4].map((i) => (
                  <LucideStar key={i} className="w-4 h-4 fill-[#FDD264] text-[#FDD264]" />
                ))}
            ...
            <div className="flex-1 space-y-2.5">
              {[
                ...
                <div key={item.star} className="flex items-center gap-3">
                  <span className="text-sm font-medium text-secondary w-2">{item.star}</span>
                  <Progress value={item.val} className="h-2 bg-[#DEE0E3] [&>div]:bg-secondary" />
                  <span className="text-sm text-[#6B7582] w-8 text-right">{item.val}%</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="flex justify-end px-6 mb-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="sm" className="bg-[#F4F4FC] border-[#6F6F6F] rounded-[10px] text-sm h-8">
        ...
        <div className="flex-1 bg-[#F4F4FC] rounded-t-[20px] p-6 space-y-8 pb-10">
          {REVIEWS.map((review) => (
            <div key={review.id} className="flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-2 duration-500">
              {/* Info Utilizator */}
              ...
              <div className="text-[16px] leading-relaxed">
                <span className="font-bold text-[#121417]">Skill Exchanged: </span>
