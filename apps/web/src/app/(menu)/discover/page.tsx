...
import { Heart, MessageCircle, X, User, Bell, Filter, MessageSquare, SlidersHorizontal, Home, UserPen, Handshake, ScrollText, FileUser, Sparkles } from 'lucide-react';
...
export default function DiscoverPage() {
  ...
  return (
    <div className="relative bg-gray-50 min-h-screen max-w-md mx-auto overflow-hidden flex flex-col" style={{ height: '70vh' }}>
      {/* Header */}
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex flex-col items-end">
            <div className="flex items-center">
              <span className="text-amber-400 text-base font-semibold">Level 1</span>
              <Sparkles className="ml-1 w-4 h-4 text-amber-400" />
            </div>
            <div className="text-blue-950 text-sm mt-1 font-semibold">0 matches</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 mt-2">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden pb-28">
          ...
          <div className="h-32 bg-gradient-to-b from-blue-900 via-blue-900/60 to-white relative">
          ...
          <div className="px-6 pb-6 mt-24">
            <div>
              <h2 className="text-2xl font-bold text-slate-950 text-center mb-4">User, {age}</h2>
              <p className="text-cyan-800 font-['Comic-Sans-M] text-semibold text-left mb-2">Iași, România</p>
            </div>

            <p className="text-slate-950 text-sm font-['Comic-Sans-M]  mb-6">
              I am passionate about dance and have developed strong rhythm, coordination, and body control through consistent practice. Dancing allows me to express creativity and confidence.
            </p>

            {/* Skills */}
            <div className="mb-4">
              <h3 className="text-slate-950 text-xl font-semibold mb-2">Skills:</h3>
            ...
            {/* Looking to Learn */}
            <div>
              <h3 className="text-slate-950 text-xl font-semibold mb-2">Looking to learn:</h3>
              <div className="flex flex-wrap gap-2">
      ...
      {showMatchModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full mx-4 text-center">
            ...
            <p className="text-gray-600 mb-6">You and User have liked each other.</p>
