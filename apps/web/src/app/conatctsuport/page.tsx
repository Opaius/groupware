      ...
      <div className="w-full sm:max-w-[450px] md:max-w-[500px] lg:max-w-[550px]">
        ...
        <div className="pt-6 px-6 pb-4 bg-[#DCE9FB] rounded-t-[24px]">
          ...
          <p className="mt-2 text-[0.9rem] text-[#6f6f6f] leading-relaxed">
            Have a question or feedback? Send us a message and our support team will get back to you soon.
          </p>
        </div>
        ...
        <div className="bg-[#DCE9FB] rounded-b-[24px] px-6 py-6 shadow-lg">
          ...
          <div className="bg-[#c8e2fd] rounded-[20px] p-6 mb-6">
            <h3 className="text-[1rem] font-semibold text-[#1d324e] mb-3">Contact Information</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[0.9rem] text-[#6e6e6e]">support@skilltrade.app</span>
              </div>
              
              <div className="flex items-center gap-3">
                <Instagram size={20} className="text-[#1d324e]" />
                <span className="text-[0.9rem] text-[#6e6e6e]">@joinskilltrade</span>
              </div>
          ...
          <div className="bg-white rounded-[20px] p-6 mb-4">
            <p className="text-[0.85rem] text-[#545454] mb-6">
              You can fill out the form below for a faster response from our support team.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <RadioGroup value={subject} onValueChange={setSubject} className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="general" id="general" />
                    <Label htmlFor="general" className="text-[0.9rem] text-black">General Inquiry</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="account" id="account" />
                    <Label htmlFor="account" className="text-[0.9rem] text-black">Account issue</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="feature" id="feature" />
                    <Label htmlFor="feature" className="text-[0.9rem] text-black">Feature request</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="other" id="other" />
                    <Label htmlFor="other" className="text-[0.9rem] text-black">Other</Label>
                  </div>
                </RadioGroup>
              </div>
          ...
          <div className="bg-[#fffcfc] rounded-[16px] p-4 flex items-start gap-3">
            ...
            <p className="text-[0.8rem] text-[#496995] leading-relaxed">
              🔒 Safety Reminder: Never share your password or personal data in chat. Your privacy and safety come first.
            </p>
          </div>
        </div>
      </div>
